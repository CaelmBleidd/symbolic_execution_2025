...
**ДЗ_3 - Внутрипроцедурный анализ основных конструкций (`homework3/`):**

**ДЗ_4 - Символьная память (`homework4/`):**

**ДЗ_5 - Генерация тестов (`homework5/`):**

**ДЗ_6 - Межпроцедурный анализ оставшихся конструкций (`homework6/`):**
